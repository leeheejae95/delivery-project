...
class JwtTokenHelper: TokenHelperIfs {
    ...
    private val refreshTokenHour: Long=12

    override fun issueAccessToken(data: Map<String, Any>?): TokenDto? {

        val expiredAtLocalDateTime = LocalDateTime.now().plusHours(accessTokenPlusHour)
    ...
    override fun issueRefreshToken(data: Map<String, Any>?): TokenDto? {
        val expiredAtLocalDateTime = LocalDateTime.now().plusHours(refreshTokenHour)
